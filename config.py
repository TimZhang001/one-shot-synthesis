...
def get_arguments():
    ...
    # basics:
    # Tim.Zhang
    parser.add_argument('--exp_name', help='experiment name for trained folder', default="mvtec")
    ...
    # Tim.Zhang
    parser.add_argument('--max_size', type=int, help='limit image size in max dimension', default=330)
    ...
    parser.add_argument('--use_kornia_augm', action='store_true', help='use an older version of differentiable augm', default=True)

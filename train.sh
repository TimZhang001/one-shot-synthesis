...
python train.py --exp_name mvtec_carpet_mask_aug1_LL3 --dataset_name carpet  --num_epochs 100000 --max_size 224 --device_ids 7 --use_masks 1 --use_kornia_augm 1 --prob_augm 0.5 --use_read_augm 1
...
python test.py  --exp_name mvtec_carpet_no_mask_aug4cutpaste --dataset_name carpet --which_epoch 100000 --max_size 224 --device_ids 0 --use_masks 0 --num_generated 1000


# evaluate
python evaluate.py --exp_name mvtec_carpet_no_mask_aug4cutpaste --epoch 00100000 --sifid_all_layers False
